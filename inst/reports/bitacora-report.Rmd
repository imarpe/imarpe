...
```{r, echo=FALSE, cache=TRUE, message=FALSE, warning= FALSE, fig.height=6, fig.width=11.5}
...
.plotEffort.bitacora(effort1 = esfuerzoAnchNC_tt, effort2 = esfuerzoAnchNC_hn, labAxis2 = "Horas de viaje", labAxis4 = "N\u{00FA}mero de calas", colBar="gray", colLine = "black", legend = c("Duracion del viaje", "N\u{00FA}mero de calas"))
