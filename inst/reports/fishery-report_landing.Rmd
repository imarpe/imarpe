...
plot(x, language = "spanish", ploType = "plotDaily", col = "black", main = "")
```
...
# Desembarques diarios y acumulados en la región Norte-Centro
```{r, cache=TRUE, echo=FALSE, message=FALSE, fig.height=6, fig.width=9, dpi=72}
plot(x, language = "spanish", ploType = "plotNC", textAxis2= "Desembarque diario (t)", textAxis4="Desembarque acomulado (miles t)")
```

\pagebreak

# Desembarques diarios y acumulados en la región Sur
```{r, cache=TRUE, echo=FALSE, message=FALSE, fig.height=6, fig.width=9, dpi=72}
plot(x, language = "spanish", ploType = "plotS", textAxis2= "Desembarque diario (t)", textAxis4="Desembarque acomulado (miles t)")
```
