...
# Crear un objeto de la clase cpue usando la base de datos ejemplo (fisheryData) de caballa
cpue  = getFishingData(file = fisheryData, type = "cpue", varType = "cpue", sp = "caballa",
